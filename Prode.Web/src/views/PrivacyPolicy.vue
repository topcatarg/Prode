<template>
    <div class="container" >
        <b-jumbotron class="mt-2" border-variant="dark" bg-variant="info">
            <template slot="header">
                <strong>POLÍTICA DE PRIVACIDAD</strong>
            </template>
            <p>
                La presente Política de Privacidad establece los términos en que esta pagina usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio web. 
            ...
            <p>
                Nuestro sitio web podrá recoger información personal por ejemplo: Nombre,&nbsp; información de contacto como&nbsp; su dirección de correo electrónica. 
            </p>
            <p>
                <strong>Uso de la información recogida</strong>
            </p>
            <p>
                Este sitio está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
            </p>
            <p>
            ...
            <p>
                Nuestro sitio web emplea las cookies solamente para registrar quien es el usuario que visita la pagina. No se guarda ninguna clase de informacion sobre que se visito o que se hizo en el sitio.
            ...
            <p>
                El sitio se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
            </p>
        </b-jumbotron>
    </div>
</template>
